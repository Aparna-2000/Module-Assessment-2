...
{   
    ...
    {  
        ...
        {   
            String id = null;  
            String productName = null,choice;  
            int quantity = 0;  
            double price = 0.0;  
            double totalPrice = 0.0;  
            double overAllPrice = 0.0;  
            double gst, subtotal=0.0;  
            ...
            System.out.println("\t\t\t\t\t"+"  "+"Zampa Mart");  
            System.out.println("\t\t\t\t #3/789, Doddanekkundi, Bangalore-560037"); 
            ...
            {  
                p.display();  
                    ...
                    System.out.println("\n\t\t\t\t\t\t\t\t\t            Grand Total (Rs.) " +(overAllPrice+gst));  
